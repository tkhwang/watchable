...
```typescript
// @watchable/shared/domain/value-objects/duration.ts
...
```typescript
// @watchable/shared/domain/value-objects/color.ts
...
```typescript
// @watchable/shared/domain/value-objects/time-range.ts
...
```typescript
// @watchable/shared/domain/entities/task.ts
...
```typescript
// @watchable/shared/domain/entities/time-entry.ts
...
```typescript
// @watchable/shared/domain/entities/user-profile.ts
...
```typescript
// @watchable/shared/domain/services/timer-service.ts
...
## 6. Type Sharing: `@watchable/shared` Monorepo Package

### 결정

Domain 계층(Entity, VO, Domain Service)을 `@watchable/shared` 패키지에 위치시켜 모든 앱에서 공유한다.
